...
#' @param t_start time value, First time in the day when payments are sent.
#'                Defaults to NULL, taking the time of the first payment in the
#'                data as it's value.
#' @param t_end time value, Last time in the day when payments are sent.
...
#'
agg_avg_net_position <- function(payments, debit,
